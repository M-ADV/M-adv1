          ...
          <div className="container p-4">
            <div className="row mt-4">
              <div className="col-lg-4 col-md-12 mb-4 mb-md-0">
                ...
                <p>
                  Welcome to M-Advisor, your trusted source for mortgage loans.
              ...
              <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <ul className="fa-ul" style={{ marginLeft: "1.65em" }}>
                  <li className="mb-3">
                    ...
                    <span className="ms-3">Adibatla,Hyderabad,501510</span>
                  </li>
                  <li className="mb-3">
                    <span className="fa-li">
                      <i className="bi bi-envelope fs-3"></i>
                    </span>
                    <span className="ms-3">MAdvisor@outlook.com</span>
                  </li>
                  <li className="mb-3">
                    <span className="fa-li">
                      <i className="bi bi-telephone-inbound fs-3 "></i>
                    </span>
                    <span className="ms-3 my-auto ">+919912622103 </span>
                  </li>
                </ul>
              </div>
